...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post parametros_url, params: { parametro: { descripcion: @parametro.descripcion, medio: @parametro.medio, nombre: @parametro.nombre, tiempo_respuesta: @parametro.tiempo_respuesta } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { descripcion: @parametro.descripcion, medio: @parametro.medio, nombre: @parametro.nombre, tiempo_respuesta: @parametro.tiempo_respuesta } }
