...
class SeguimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seguimiento" do
    assert_difference('Seguimiento.count') do
      post seguimientos_url, params: { seguimiento: { descripcion: @seguimiento.descripcion, fecha: @seguimiento.fecha, hora: @seguimiento.hora, id_tipo_seguimiento: @seguimiento.id_tipo_seguimiento } }
    end
  ...
  test "should update seguimiento" do
    patch seguimiento_url(@seguimiento), params: { seguimiento: { descripcion: @seguimiento.descripcion, fecha: @seguimiento.fecha, hora: @seguimiento.hora, id_tipo_seguimiento: @seguimiento.id_tipo_seguimiento } }
