...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { nombre_area: @area.nombre_area, telefono_area: @area.telefono_area } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { nombre_area: @area.nombre_area, telefono_area: @area.telefono_area } }
